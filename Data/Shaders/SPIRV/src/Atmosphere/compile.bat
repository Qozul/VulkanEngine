...
C:\VulkanSDK\1.1.121.2\Bin\glslc.exe ap_scattering.comp -c -o ../../AerialPerspectiveScattering.spv
C:\VulkanSDK\1.1.121.2\Bin\glslc.exe ap_transmittance.comp -c -o ../../AerialPerspectiveTransmittance.spv
pause